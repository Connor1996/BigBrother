...
async fn pr_detail_page_uses_bigbrother_branding() {
    ...
    assert!(
        html.contains("<title>BigBrother Run View</title>")
            ...
            && html.contains("renderedTerminalRecording !== recording")
            && html.contains("nextViewport.scrollTop = previousScrollTop;")
