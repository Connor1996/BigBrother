...
- the embedded terminal should reserve visible outer gutter space for its vertical scrollbar so the handle sits beside the content area instead of on top of the rightmost text columns
